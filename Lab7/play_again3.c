...
//signal handler for part B where if a keyboard signal is recieved the resets and exits with value 2
void reset_exit(int signum)
{
	tty_mode(1);
	printf("\n\nkeyboard signal\n\n");
	exit(2);
...
//changed to only except a yes or no response
